  ...
  return (
    <>
      <footer className="text-white">
          ...
          <div className="max-w-screen-xl mx-auto">
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
              ...
              <ul className="flex gap-3 justify-center pt-3 text-md">
                <li><i className="fa-brands fa-facebook p-1 border-2 rounded-full border-white"></i></li>
                <li><i className="fa-brands fa-twitter p-1 border-2 rounded-full border-white"></i></li>
                <li><i className="fa-brands fa-linkedin-in p-1 border-2 rounded-full border-white"></i></li>
                <li><i className="fa-solid fa-globe p-1 border-2 rounded-full border-white"></i></li>
              </ul>
              </div>
              <div className="col-span-1">
        ...
        <div className="bg-customDarkBlue text-center py-4 text-lg ">
